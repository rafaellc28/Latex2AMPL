...
class LinearExpressionBetweenParenthesis(LinearExpression):
    ...
    def generateCode(self, codeGenerator):
        """
        Generate the AMPL code for this linear expression
        """
        return codeGenerator.generateCode(self)
...
class LinearExpressionWithArithmeticOperation(LinearExpression):
    ...
    def generateCode(self, codeGenerator):
        """
        Generate the AMPL code for this linear expression with arithmetic pperation
        """
        return codeGenerator.generateCode(self)
...
class MinusLinearExpression(LinearExpression):
    ...
    def generateCode(self, codeGenerator):
        """
        Generate the AMPL code for this minus linear expression
        """
        return codeGenerator.generateCode(self)
...
class ConditionalLinearExpression(LinearExpression):
    ...
    def setupEnvironment(self, codeSetup):
        """
        Generate the AMPL code for the identifiers and sets used in this conditional linear expression
        """
        codeSetup.setupEnvironment(self)

    def generateCode(self, codeGenerator):
        """
        Generate the AMPL code for this contitional linear expression
        """
        return codeGenerator.generateCode(self)
