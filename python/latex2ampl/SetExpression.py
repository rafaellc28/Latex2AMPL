...
class SetExpressionWithValue(SetExpression):
    ...
    def generateCode(self, codeGenerator):
        """
        Generate the AMPL code for this Set expression
        """
...
class IteratedSetExpression(SetExpression):
    ...
    def __str__(self):
        ...
        if self.supExpression != None:
            res += " {" + str(self.indexingExpression) + "..(" + str(self.supExpression) + ")}"
        else:
    ...
    def setupEnvironment(self, codeSetup):
        """
        Generate the AMPL code for the identifiers and sets used in this iterated set expression
        """
        codeSetup.setupEnvironment(self)

    def generateCode(self, codeGenerator):
        """
        Generate the AMPL code for this contitional set expression
        """
        return codeGenerator.generateCode(self)
...
class ConditionalSetExpression(SetExpression):
    ...
    def setupEnvironment(self, codeSetup):
        """
        Generate the AMPL code for the identifiers and sets used in this conditional set expression
        """
        codeSetup.setupEnvironment(self)
