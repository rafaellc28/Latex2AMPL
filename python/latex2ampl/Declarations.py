class Declarations:
    ...
    def setupEnvironment(self, codeSetup):
        """
        Generate the AMPL  code for the identifiers and sets used in these declarations
        """
...
class Declaration:
    ...
    def setupEnvironment(self, codeSetup):
        """
        Generate the AMPL  code for declaration of identifiers and sets in this declaration
        """
        codeSetup.setupEnvironment(self)
