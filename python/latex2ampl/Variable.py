...
class Variable(Expression):
    ...
    def setupEnvironment(self, codeSetup):
        """
        Generate the AMPL code for the declaration of this variable
        """
        codeSetup.setupEnvironment(self)

    def generateCode(self, codeGenerator):
        """
        Generate the AMPL code for this Variable
        """
        return codeGenerator.generateCode(self)
    
    def generateCodeWithoutIndices(self, codeGenerator):
        """
        Generate the AMPL code for this Variable without the Indexing, if there are 
        """
